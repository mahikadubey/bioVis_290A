...
for line in all[1:3]:
    ...
    first = '{"title": "' + str(gene_id[0:4]) + '-' + str(gene_id[10:]) + '" , "subtitle": "RNF43_WT", "ranges": [0, 8, 8], "measures": [4, 8], "markers":' + markers1 + '}'
    data.append(first)
    ...
    second = '{"title": "' + str(gene_id[0:4]) + '-' + str(gene_id[10:]) + '", "subtitle": "GFP", "ranges": [0, 8, 8], "measures": [4, 8], "markers":' + markers2 + '}'
    data.append(second)
    ...
    third = '{"title": "' + str(gene_id[0:4]) + '-' + str(gene_id[10:]) + '", "subtitle": "RNF43_659fs", "ranges": [0, 8, 8], "measures": [4, 8], "markers":' + markers3 + '}'
    data.append(third)
    ...
    fourth = '{"title": "' + str(gene_id[0:4]) + '-' + str(gene_id[10:]) + '", "subtitle": "RNF43_117fs", "ranges": [0, 8, 8], "measures": [4, 8], "markers":' + markers4 + '}'
    data.append(fourth)
